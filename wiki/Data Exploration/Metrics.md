...
Repository: https://github.com/pharo-ai/metrics#classification-metrics

In this packages we have implemented several metris for different machine learning algorithm types.

_Note: More metrics will be added in the future. Maybe those metrics will take some time to be in the wiki. Nevertheless, the README of the repository will be always up-to-date._
